...
<main>
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center><h1>Editar Empleado</h1><i class="fa-solid fa-user fa-2xl"></i></center>
        </div>
      </div>
    ...
    <div class="row align-items-md-stretchS py-4">
        ...
        <form role="form "action="<?= PATH ?>/Empresas/updateEmpleados" method="POST">
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="text" class="form-control" readonly="true" name="ID_Empleado" id="ID_Empleado"  value="<?= isset($empleado)?$empleado['ID_Empleado']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="email" class="form-control" readonly="true" name="Correo" id="Correo" placeholder="correo electronico: name@example.com" value="<?= isset($empleado)?$empleado['Correo']:'' ?>" >
                </div>
            </div>
