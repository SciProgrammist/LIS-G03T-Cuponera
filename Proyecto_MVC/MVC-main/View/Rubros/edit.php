    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center><h1>Editar Rubro</h1> <i class="fa-solid fa-list fa-2xl"></i></i></center>
        </div>
      </div>
        ...
        <form role="form "action="<?= PATH ?>/Rubros/update" method="POST">
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="text" class="form-control" readonly="true" name="ID_Rubro" id="ID_Rubro" placeholder="Ingresa el Codigo del Rubro" value="<?= isset($rubro)?$rubro['ID_Rubro']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" name="Nombre_Rubro" id="Nombre_Rubro" placeholder="Ingresa el Nomnre de la Empresa" value="<?= isset($rubro)?$rubro['Nombre_Rubro']:'' ?>" >
                </div>
            </div>
            ...
            <a class="btn btn-danger" href="<?= PATH ?>/Rubros/index">Cancelar</a>
