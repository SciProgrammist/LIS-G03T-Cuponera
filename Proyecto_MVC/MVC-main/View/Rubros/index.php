    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          ...
          <div class="d-flex justify-content-around">
            <a type="button" class="btn btn-light" href="<?=PATH?>/Rubros/create"><i class="fa-solid fa-plus fa-lg"></i>  Agregar Rubro</a>
        ...
        <table class="table table-striped table-bordered table-hover table-responsive table-condensed" id="tabla" style="margin-top:20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-primary m-2" href="<?= PATH.'/Rubros/edit/'.$rubro['ID_Rubro']?>"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                          <a type="button" class="btn btn-danger" href="<?= PATH ?>/Rubros/remove/<?= $rubro['ID_Rubro'] ?>"><i class="fa-solid fa-delete-left"></i> Eliminar</button>                   
                        </td>
                    </tr>
                    <?php         
                    }
