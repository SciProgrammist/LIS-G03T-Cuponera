    ...
    <div class="row align-items-md-stretchS py-4">
        ...
        <form role="form "action="<?= PATH ?>/Cupones/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" readonly="true" name="Estado_Oferta" id="Estado_Oferta" value="<?= isset($oferta)?$oferta['Estado_Oferta']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-regular fa-comment fa-lg"></i></span>
                    <textarea class="form-control" readonly="true" placeholder="Justificacion de la Oferta" id="Justificacion" name="Justificacion" ><?= isset($oferta)?$oferta['Justificacion']:'' ?></textarea>
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="text" class="form-control" readonly="true" name="id_empresa" id="id_empresa" value="<?= isset($oferta)?$oferta['id_empresa']:'' ?>" >
