      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          ...
          <div class="d-flex justify-content-around">
            ...
            <a type="button" class="btn btn-light" href="<?=PATH?>/Categorias/index"><i class="fa-solid fa-pen-to-square fa-lg"></i>  Gestion de Rubros</a>
            <a type="button" class="btn btn-light" href="<?=PATH?>/Usuarios/index"><i class="fa-solid fa-user-pen fa-lg"></i>  Detalle de Clientes</a>
            <a type="button" class="btn btn-light" href="<?=PATH?>/Productos/Detalles"><i class="fa-solid fa-chart-column fa-lg"></i>  Detalle de Ofertas</a>
          </div>
        </div>
      </div>
